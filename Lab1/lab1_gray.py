# -*- coding: utf-8 -*-
"""Копия блокнота "Lab1.ipynb"

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1ahY_n_QQDCpPJ8RRQ2dosOC9_sWHAZMo
"""
...
trainX = np.reshape(trainX, (len(trainY), width * width))
...
testX = np.reshape(testX, (len(testY), width * width))
...
model = Sequential()
model.add(Dense(1000, input_dim=(width * width), activation="sigmoid"))
